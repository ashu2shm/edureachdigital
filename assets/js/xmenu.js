...
var XMENU = function () {
	...
	var xMenuToggler = function (){ if (jQuery('.xmenu-toggler').length > 0) { jQuery('.xmenu-toggler').on('click', function () { var target = $(this).data('target'); $('body').addClass('fixed'); $(this).addClass('open'); $(target).addClass('show'); }); jQuery('.menu-close').on('click', function () { $('.xmenu-toggler').removeClass('open'); $('body').removeClass('fixed'); $('.xmenu').removeClass('show'); }); } }
